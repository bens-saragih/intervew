...
<div class="container">
    <div class="row justify-content-center" style="width:1200px ;">
        <div class="col-md-8">
             <form action="{{ route('YWRtaW5rYWg.update',$article[0]->slug) }}" method="post" enctype="multipart/form-data">
                        @method('PATCH')
                        @csrf
                <div class="mb-3">
                  <label for="judul" class="form-label">Judul</label>
                  <input type="text" class="form-control" id="judul" name="judul" value="{{ old('judul') ?? $article[0]->judul ?? ''}}">
                </div>
                 <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <textarea name="isi" class="my-editor form-control" id="my-editor" cols="50" rows="20">{{ old('isi') ?? $article[0]->isi ?? ''}}</textarea>
                </div>
